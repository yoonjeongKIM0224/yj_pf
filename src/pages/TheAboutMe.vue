        ...
        <div class="intro_wrap">
            ...
            <div class="text_wrap">
                ...
                <p class="text">
                    안녕하세요!<br>
                    4년차 웹퍼블리셔 김윤정입니다.<br>
                    웹에이전시에서 정규직으로 근무하며 신한은행, 농협카드, 고용24, 삼성 등 여러 프로젝트에서 실무한 경험이 있습니다.<br>
                    유지보수를 고려하여 중복되는 코드 없이 깔끔하고 용이한 코드 작성을 추구합니다.<br>
                    Figma, PS 등 디자인 툴을 사용해 보는 것을 좋아합니다.<br>
                    <br>
                    항상 제작자의 입장으로 프로젝트의 전체적인 흐름을 파악하고자 하는 마인드를 가지며 작업합니다.<br>
                    <br>
                    잘 부탁드립니다.
                </p>
                <TheButton
            ...
            history: [
                ...
                },
                {
                    ...
                    months: [
                        ...
                        },
                        {
                            ...
                            title: '(주)더웹스타일 퇴사',
                            text: '웹퍼블리셔 (1년 5개월)',
                            img: require('../assets/images/thewebstyle.png'),
                            alt: 'thewebstyle',
                            active: false
                        },
                        {
                ...
                },
                {
                    ...
                    months: [
                        {
                            date: '08',
                            title: '웹디자인&웹퍼블리싱 과정 수료',
                            text: '방송정보국제교육원 (6개월)',
                            img: require('../assets/images/html_css.png'),
                            alt: 'html css',
                            active: false
                        },
                    ]
                    ...
                    months: [
                        {
                            date: '12',
                            title: '(주)스카이라인스포츠 퇴사',
                            text: '관리부 경영관리자 (1년 10개월)',
                            img: require('../assets/images/skyline.png'),
                            alt: 'skyline',
                            active: false
                        },
                    ]
